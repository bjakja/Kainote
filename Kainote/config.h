...
#define CFG(CG) \
	...
	CG(CALC_SPACES_AND_PUNCTATION_FOR_WRAPS,)\
	CG(CALC_SPACES_AND_PUNCTATION_FOR_CPS,)\
	...
	CG(UPDATER_AUTO_CHECK,)\
	CG(UPDATER_CHECK_FOR_STABLE,)\
	CG(UPDATER_NEXT_CHECK,)\
	CG(VIDEO_FULL_SCREEN_ON_START,)\
	CG(VIDEO_GPU_CONVERSION,)\
	CG(VIDEO_INDEX,)\
