...
{
	if (!Audio){
		_hkeys[idAndType(GLOBAL_QUIT, GLOBAL_HOTKEY)] = hdata(_(L"Wyjście"), L"Alt-F4");
		_hkeys[idAndType(GLOBAL_ADD_PAGE, GLOBAL_HOTKEY)] = hdata(_(L"Otwórz nową zakładkę"), L"Ctrl-T");
		_hkeys[idAndType(GLOBAL_CLOSE_PAGE, GLOBAL_HOTKEY)] = hdata(_(L"Zamknij bieżącą zakładkę"), L"Ctrl-W");
		_hkeys[idAndType(GLOBAL_SHOW_SHIFT_TIMES, GLOBAL_HOTKEY)] = hdata(_(L"Okno zmiany czasów"), L"Ctrl-I");
		...
		_hkeys[idAndType(GLOBAL_OPEN_STYLE_MANAGER, GLOBAL_HOTKEY)] = hdata(_(L"Menedżer stylów"), L"Ctrl-M");
		_hkeys[idAndType(GLOBAL_EDITOR, GLOBAL_HOTKEY)] = hdata(_(L"Włącz / Wyłącz edytor"), L"Ctrl-E");
		_hkeys[idAndType(GLOBAL_OPEN_VIDEO, GLOBAL_HOTKEY)] = hdata(_(L"Otwórz wideo"), L"Ctrl-Shift-O");
		_hkeys[idAndType(GLOBAL_SEARCH, GLOBAL_HOTKEY)] = hdata(_(L"Znajdź"), L"Ctrl-F");
		_hkeys[idAndType(GLOBAL_FIND_REPLACE, GLOBAL_HOTKEY)] = hdata(_(L"Znajdź i zmień"), L"Ctrl-H");
		_hkeys[idAndType(GLOBAL_UNDO, GLOBAL_HOTKEY)] = hdata(_("Cofnij"), L"Ctrl-Z");
		_hkeys[idAndType(GLOBAL_REDO, GLOBAL_HOTKEY)] = hdata(_(L"Ponów"), L"Ctrl-Y");
		_hkeys[idAndType(GLOBAL_HISTORY, GLOBAL_HOTKEY)] = hdata(_("Historia"), L"Ctrl-Shift-H");
		_hkeys[idAndType(GLOBAL_OPEN_SUBS, GLOBAL_HOTKEY)] = hdata(_(L"Otwórz napisy"), L"Ctrl-O");
		...
		_hkeys[idAndType(GLOBAL_REMOVE_TEXT, GLOBAL_HOTKEY)] = hdata(_(L"Usuń tekst"), L"Alt-Delete");
		_hkeys[idAndType(GLOBAL_REMOVE_LINES, GLOBAL_HOTKEY)] = hdata(_(L"Usuń linijkę"), L"Shift-Delete");
		_hkeys[idAndType(GLOBAL_SET_START_TIME, GLOBAL_HOTKEY)] = hdata(_(L"Wstaw czas początkowy z wideo"), L"Ctrl-Left");
		_hkeys[idAndType(GLOBAL_SET_END_TIME, GLOBAL_HOTKEY)] = hdata(_(L"Wstaw czas końcowy z wideo"), L"Ctrl-Right");
		_hkeys[idAndType(GLOBAL_PLAY_PAUSE, GLOBAL_HOTKEY)] = hdata(_(L"Odtwórz / Pauza"), L"Alt-Space");
		_hkeys[idAndType(GLOBAL_PREVIOUS_FRAME, GLOBAL_HOTKEY)] = hdata(_(L"Klatka w tył"), L"Left");
		_hkeys[idAndType(GLOBAL_NEXT_FRAME, GLOBAL_HOTKEY)] = hdata(_(L"Klatka w przód"), L"Right");
		_hkeys[idAndType(GLOBAL_PREVIOUS_LINE, GLOBAL_HOTKEY)] = hdata(_("Poprzednia linijka"), L"Ctrl-Up");//góra
		_hkeys[idAndType(GLOBAL_NEXT_LINE, GLOBAL_HOTKEY)] = hdata(_(L"Następna linijka"), L"Ctrl-Down");//dół
		_hkeys[idAndType(GLOBAL_FIND_NEXT, GLOBAL_HOTKEY)] = hdata(_(L"Znajdź następny"), L"F3");
		_hkeys[idAndType(GLOBAL_JOIN_WITH_PREVIOUS, GLOBAL_HOTKEY)] = hdata(_(L"Scal z poprzednią linijką"), L"F4");
		_hkeys[idAndType(GLOBAL_JOIN_WITH_NEXT, GLOBAL_HOTKEY)] = hdata(_(L"Scal z następną linijką"), L"F5");
		...
		_hkeys[idAndType(GLOBAL_NEXT_TAB, GLOBAL_HOTKEY)] = hdata(_(L"Następna karta"), L"Ctrl-PgDn");
		_hkeys[idAndType(GLOBAL_PREVIOUS_TAB, GLOBAL_HOTKEY)] = hdata(_("Poprzednia karta"), L"Ctrl-PgUp");
		_hkeys[idAndType(GLOBAL_SELECT_FROM_VIDEO, GLOBAL_HOTKEY)] = hdata(_(L"Zaznacz linię z czasem wideo"), L"F2");
		...
		_hkeys[idAndType(GRID_SHOW_PREVIEW, GRID_HOTKEY)] = hdata(_(L"Pokaż podgląd napisów"), L"Ctrl-Q");
		_hkeys[idAndType(VIDEO_PLAY_PAUSE, VIDEO_HOTKEY)] = hdata(_(L"Odtwórz / Pauza"), L"Space");
		_hkeys[idAndType(VIDEO_5_SECONDS_FORWARD, VIDEO_HOTKEY)] = hdata(_("5 sekund do przodu"), L"L");
		_hkeys[idAndType(VIDEO_5_SECONDS_BACKWARD, VIDEO_HOTKEY)] = hdata(_(L"5 sekund do tyłu"), L";");
		_hkeys[idAndType(VIDEO_MINUTE_FORWARD, VIDEO_HOTKEY)] = hdata(_("Minuta do przodu"), L"Up");
		_hkeys[idAndType(VIDEO_MINUTE_BACKWARD, VIDEO_HOTKEY)] = hdata(_(L"Minuta do tyłu"), L"Down");
		_hkeys[idAndType(VIDEO_NEXT_FILE, VIDEO_HOTKEY)] = hdata(_(L"Następny plik"), L".");
		_hkeys[idAndType(VIDEO_PREVIOUS_FILE, VIDEO_HOTKEY)] = hdata(_("Poprzedni plik"), L",");
		_hkeys[idAndType(VIDEO_VOLUME_PLUS, VIDEO_HOTKEY)] = hdata(_(L"Dźwięk głośniej"), L"Num .");
		_hkeys[idAndType(VIDEO_VOLUME_MINUS, VIDEO_HOTKEY)] = hdata(_(L"Dźwięk ciszej"), L"Num 0");
		_hkeys[idAndType(VIDEO_NEXT_CHAPTER, VIDEO_HOTKEY)] = hdata(_(L"Następny rozdział"), L"M");
		_hkeys[idAndType(VIDEO_PREVIOUS_CHAPTER, VIDEO_HOTKEY)] = hdata(_(L"Poprzedni rozdział"), L"N");
		_hkeys[idAndType(EDITBOX_INSERT_BOLD, EDITBOX_HOTKEY)] = hdata(_("Wstaw pogrubienie"), L"Ctrl-B");
		_hkeys[idAndType(EDITBOX_INSERT_ITALIC, EDITBOX_HOTKEY)] = hdata(_(L"Wstaw kursywę"), L"Ctrl-I");
		_hkeys[idAndType(EDITBOX_SPLIT_LINE, EDITBOX_HOTKEY)] = hdata(_(L"Wstaw znak podziału"), L"Shift-Enter");
		_hkeys[idAndType(EDITBOX_START_DIFFERENCE, EDITBOX_HOTKEY)] = hdata(_(L"Wstaw różnicę początkową"), L"Ctrl-,");
		_hkeys[idAndType(EDITBOX_END_DIFFERENCE, EDITBOX_HOTKEY)] = hdata(_(L"Wstaw różnicę końcową"), L"Ctrl-.");
		_hkeys[idAndType(EDITBOX_FIND_NEXT_DOUBTFUL, EDITBOX_HOTKEY)] = hdata(_(L"Następne niepewne"), L"Ctrl-D");
		_hkeys[idAndType(EDITBOX_FIND_NEXT_UNTRANSLATED, EDITBOX_HOTKEY)] = hdata(_(L"Następne nieprzetłumaczone"), L"Ctrl-R");
		_hkeys[idAndType(EDITBOX_SET_DOUBTFUL, EDITBOX_HOTKEY)] = hdata(_(L"Ustaw jako niepewne i przejdź dalej"), L"Alt-Down");
		_hkeys[idAndType(EDITBOX_COMMIT, EDITBOX_HOTKEY)] = hdata(_(L"Zatwierdź zmiany"), L"Ctrl-Enter");
		_hkeys[idAndType(EDITBOX_COMMIT_GO_NEXT_LINE, EDITBOX_HOTKEY)] = hdata(_(L"Zatwierdź zmiany idź do następnej linii"), L"Enter");
	}
	else{
		_hkeys[idAndType(AUDIO_COMMIT, AUDIO_HOTKEY)] = hdata(_(L"Zatwierdź"), L"Enter");
		_hkeys[idAndType(AUDIO_COMMIT_ALT, AUDIO_HOTKEY)] = hdata(_(L"Zatwierdź zastępcze"), L"G");
		_hkeys[idAndType(AUDIO_PREVIOUS, AUDIO_HOTKEY)] = hdata(_("Poprzednia linijka"), L"Left");
		_hkeys[idAndType(AUDIO_PREVIOUS_ALT, AUDIO_HOTKEY)] = hdata(_(L"Poprzednia linijka zastępcze"), L"Z");
		_hkeys[idAndType(AUDIO_NEXT, AUDIO_HOTKEY)] = hdata(_(L"Następna linijka"), L"Right");
		_hkeys[idAndType(AUDIO_NEXT_ALT, AUDIO_HOTKEY)] = hdata(_(L"Następna linijka zastępcze"), L"X");
		_hkeys[idAndType(AUDIO_PLAY, AUDIO_HOTKEY)] = hdata(_("Odtwarzaj"), L"Down");
		_hkeys[idAndType(AUDIO_PLAY_ALT, AUDIO_HOTKEY)] = hdata(_(L"Odtwarzaj zastępcze"), L"S");
		_hkeys[idAndType(AUDIO_PLAY_LINE, AUDIO_HOTKEY)] = hdata(_(L"Odtwarzaj linię"), L"Up");
		_hkeys[idAndType(AUDIO_PLAY_LINE_ALT, AUDIO_HOTKEY)] = hdata(_(L"Odtwarzaj linię zastępcze"), L"R");
		_hkeys[idAndType(AUDIO_STOP, AUDIO_HOTKEY)] = hdata(_("Zatrzymaj"), L"H");
		_hkeys[idAndType(AUDIO_GOTO, AUDIO_HOTKEY)] = hdata(_(L"Przejdź do zaznaczenia"), L"B");
		_hkeys[idAndType(AUDIO_SCROLL_RIGHT, AUDIO_HOTKEY)] = hdata(_(L"Przewiń w lewo"), L"A");
		_hkeys[idAndType(AUDIO_SCROLL_LEFT, AUDIO_HOTKEY)] = hdata(_(L"Przewiń w prawo"), L"F");
		...
		_hkeys[idAndType(AUDIO_PLAY_500MS_LAST, AUDIO_HOTKEY)] = hdata(_(L"Odtwarzaj końcowe 500ms"), L"D");
		...
		_hkeys[idAndType(AUDIO_PLAY_TO_END, AUDIO_HOTKEY)] = hdata(_(L"Odtwarzaj do końca"), L"T");
		_hkeys[idAndType(AUDIO_LEAD_IN, AUDIO_HOTKEY)] = hdata(_(L"Dodaj wstęp"), L"C");
		_hkeys[idAndType(AUDIO_LEAD_OUT, AUDIO_HOTKEY)] = hdata(_(L"Dodaj zakończenie"), L"V");
	}
}
...
int Hotkeys::LoadHkeys(bool Audio)
{
	...
	if (!checkVer){
		KaiMessageBox(_(L"Plik skrótów jest przestarzały zostanie zamieniony domyślnym"));
		LoadDefault(hkeys, Audio);
		SaveHkeys(Audio);
		return 1;
	}
...
wxAcceleratorEntry Hotkeys::GetHKey(const idAndType itype, const hdata *data)
{
	...
	if (key == 0 && akey.length() < 2){ key = static_cast<int>(akey[0]); }
		...
		KaiLog(wxString::Format(_(L"Skrót \"%s\" nie jest prawidłowy"), akey));
	}
...
void Hotkeys::ResetKey(const idAndType *itype, int id, char type)
{
	...
	if (it != tmphkeys.end())
	{
		...
		KaiLog(wxString::Format(_(L"Nie można przywrócić skrótu, bo nie ma domyślnego ustawienia o id %i"), tmpitype.id));
	}
}
...
HkeysDialog::HkeysDialog(wxWindow *parent, wxString name, char hotkeyWindow, bool showWindowSelection)
	: KaiDialog(parent, -1, _(L"Mapowanie przycisków"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxWANTS_CHARS | wxCLOSE_BOX)
{
	SetForegroundColour(Options.GetColour(WINDOW_TEXT));
	SetBackgroundColour(Options.GetColour(WINDOW_BACKGROUND));
	global = nullptr;
	const int elems = 5;
	wxString windows[elems] = { _(L"Skrót globalny"), _(L"Skrót pola napisów"),
		_(L"Skrót pola edycji"), _(L"Skrót wideo"), _(L"Skrót audio") };
	...
	KaiStaticText *txt = new KaiStaticText(this, -1, 
		wxString::Format(_(L"Proszę wcisnąć klawisze skrótu dla \"%s\"."), name),
...
void HkeysDialog::OnKeyPress(wxKeyEvent& event)
{
	...
	if (key != WXK_SHIFT && key != WXK_ALT && key != WXK_CONTROL){
		...
		{
			KaiMessageBox(_(L"Skróty globalne i edytora muszą zawierać modyfikatory (Shift, Ctrl lub Alt).")); return;
		}
		else if (event.GetModifiers() == wxMOD_CONTROL && (key == L'V' || key == L'C' || key == L'X' || key == L'Z')){
			KaiMessageBox(_(L"Nie można używać skrótów do kopiowania, wycinania i wklejania.")); return;
		}
		else if (event.AltDown() && !event.ControlDown() && key == WXK_F4){
			KaiMessageBox(_(L"Nie można używać skrótu zamykania programu.")); return;
		}
