...
void PopupWindow::OnMouseEvent(wxMouseEvent &evt)
{
	...
	if (evt.LeftUp()){
		...
		Menu listMenu;
		listMenu.Append(ID_SHOW_DESCRIPTION, _(L"Pokaż opis"), nullptr, emptyString, ITEM_CHECK_AND_HIDE)->Check((options & SHOW_DESCRIPTION) != 0);
		listMenu.Append(ID_SHOW_ALL_TAGS, _(L"Pokaż wszystkie tagi"), nullptr, emptyString, ITEM_CHECK_AND_HIDE)->Check((options & TYPE_TAG_USED_IN_VISUAL) != 0);
		listMenu.Append(ID_SHOW_VSFILTER_MOD_TAGS, _(L"Pokaż tagi VSFiltermoda"), nullptr, emptyString, ITEM_CHECK_AND_HIDE)->Check((options & TYPE_TAG_VSFILTER_MOD) != 0);
...
{
	itemsList.push_back(new TagListItem(L"1a", _(L"Przezroczystość koloru podstawowego"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"2a", _(L"Przezroczystość koloru pomocniczego"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"3a", _(L"Przezroczystość koloru obwódki"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"4a", _(L"Przezroczystość koloru cienia"), TYPE_TAG_USED_IN_VISUAL, option));
	...
	itemsList.push_back(new TagListItem(L"3c", _(L"Kolor obwódki"), TYPE_TAG_USED_IN_VISUAL, option));
	...
	itemsList.push_back(new TagListItem(L"3img", _(L"Maska PNG koloru obwódki"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"4img", _("Maska PNG koloru cienia"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"1va", _(L"Gradient przezroczystości koloru podstawowego"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"2va", _(L"Gradient przezroczystości koloru pomocniczego"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"3va", _(L"Gradient przezroczystości koloru obwódki"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"4va", _(L"Gradient przezroczystości koloru cienia"), TYPE_TAG_VSFILTER_MOD, option, true));
	...
	itemsList.push_back(new TagListItem(L"3vc", _(L"Gradient koloru obwódki"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"4vc", _("Gradient koloru cienia"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"a", _(L"Położenie tekstu (układ SSA)"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"alpha", _(L"Przezroczystość całego tekstu"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"an", _(L"Położenie tekstu"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"b", _("Pogrubienie tekstu"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"be", _(L"Rozmycie krawędzi"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"blur", _("Rozmycie"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"bord", _(L"Grubość obwódki"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"clip", _(L"Wycinki wektorowe / prostokątne"), TYPE_TAG_USED_IN_VISUAL, option, true));
	...
	itemsList.push_back(new TagListItem(L"fe", _(L"Kodowanie znaków tekstu"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"fn", _("Nazwa czcionki"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"frs", _(L"Zaokrąglenie tekstu"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"frx", _(L"Obrót w osi X"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"fry", _(L"Obrót w osi Y"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"frz", _(L"Obrót w osi Z"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"fs", _(L"Wielkość czcionki"), TYPE_TAG_USED_IN_VISUAL, option));
	...
	itemsList.push_back(new TagListItem(L"fsp", _(L"Odstępy między znakami"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"fsvp", _(L"Odstęp między znakami w pionie"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"i", _("Kursywa / pochylenie tekstu"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"iclip", _(L"Odwrócone wycinki wektorowe / prostokątne"), TYPE_TAG_USED_IN_VISUAL, option, true));
	itemsList.push_back(new TagListItem(L"jitter", _(L"Trzęsienie tekstu"), TYPE_TAG_VSFILTER_MOD, option, true));
	itemsList.push_back(new TagListItem(L"k", _("Timing karaoke"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"K", _(L"Timing karaoke płynne przejście"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"ko", _(L"Timing karaoke obwódka"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"kt", _(L"Timing karaoke (nieobsługiwane)"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"move", _("Ruch tekstu"), TYPE_TAG_USED_IN_VISUAL, option, true));
	itemsList.push_back(new TagListItem(L"mover", _(L"Ruch po okręgu"), TYPE_TAG_VSFILTER_MOD, option, true));
	...
	itemsList.push_back(new TagListItem(L"org", _(L"Kotwica dla obrotów"), TYPE_TAG_USED_IN_VISUAL, option, true));
	itemsList.push_back(new TagListItem(L"p", _("Rysunek wektorowy i skala"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"pbo", _(L"Przesunięcie punktów wektora w osi Y"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"pos", _("Pozycja tekstu"), TYPE_TAG_USED_IN_VISUAL, option, true));
	itemsList.push_back(new TagListItem(L"q", _(L"Sposób łamania linii"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"r", _(L"Reset tagów"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"rnd", _(L"Losowość punktów czcionki"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"rnds", _(L"Losowość punktów czcionki seed"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"rndx", _(L"Losowość punktów czcionki oś X"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"rndy", _(L"Losowość punktów czcionki oś Y"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"rndz", _(L"Losowość punktów czcionki oś Z"), TYPE_TAG_VSFILTER_MOD, option));
	itemsList.push_back(new TagListItem(L"s", _(L"Przekreślenie tekstu"), TYPE_TAG_USED_IN_VISUAL, option));
	itemsList.push_back(new TagListItem(L"shad", _(L"Cień tekstu"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"t", _("Animacja tekstu"), TYPE_NORMAL, option, true));
	itemsList.push_back(new TagListItem(L"u", _(L"Podkreślenie tekstu"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"xbord", _(L"Obwódka w osi X"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"ybord", _(L"Obwódka w osi Y"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"xshad", _(L"Cień w osi X"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"yshad", _(L"Cień w osi Y"), TYPE_NORMAL, option));
	itemsList.push_back(new TagListItem(L"z", _(L"Koordynata Z dla tagów \\frx i \\fry"), TYPE_TAG_VSFILTER_MOD, option));
}
