...
#define IDS(XX) \
	...
	XX( GRID_SELECT_VISIBLE_LINES, ) \
	XX( GRID_SPLIT_BY_VIDEO_TIME, ) \
	XX( GRID_SPLIT_BY_FRAME, ) \
	XX( GRID_SPLIT_BY_CHARS, ) \
	XX( GRID_SPLIT_BY_WORDS, ) \
	XX( GRID_SPLIT_BY_WRAPS, ) \
	XX( GRID_SWAP_LINES, ) \
	...
	XX( GLOBAL_LOAD_EXTERNAL_SESSION,)\
	XX( GLOBAL_SAVE_EXTERNAL_SESSION,)\
