...
{
	{ L".ass",  IDI_FILETYPE_ASS,  "text/x-ssa",                    wxTRANSLATE(L"ASS subtitles"),  KainoteFileKind::Subtitle },
	{ L".ssa",  IDI_FILETYPE_SSA,  "text/x-ssa",                    wxTRANSLATE(L"SSA subtitles"),  KainoteFileKind::Subtitle },
	{ L".srt",  IDI_FILETYPE_SRT,  "application/x-subrip",          wxTRANSLATE(L"SRT subtitles"),  KainoteFileKind::Subtitle },
	{ L".sub",  IDI_FILETYPE_SUB,  "text/x-microdvd",               wxTRANSLATE(L"SUB subtitles"),  KainoteFileKind::Subtitle },
	{ L".txt",  IDI_FILETYPE_TXT,  nullptr,                         wxTRANSLATE(L"TXT subtitles"),  KainoteFileKind::Subtitle },
	{ L".mkv",  IDI_FILETYPE_MKV,  "video/matroska",                wxTRANSLATE(L"Video MKV"),   KainoteFileKind::Video    },
	{ L".mp4",  IDI_FILETYPE_MP4,  "video/mp4",                     wxTRANSLATE(L"Video MP4"),   KainoteFileKind::Video    },
	{ L".avi",  IDI_FILETYPE_AVI,  "video/vnd.avi",                 wxTRANSLATE(L"Video AVI"),   KainoteFileKind::Video    },
	{ L".ogm",  IDI_FILETYPE_OGM,  "video/x-ogm+ogg",               wxTRANSLATE(L"Video OGM"),   KainoteFileKind::Video    },
	{ L".wmv",  IDI_FILETYPE_WMV,  "video/x-ms-wmv",                wxTRANSLATE(L"Video WMV"),   KainoteFileKind::Video    },
	{ L".asf",  IDI_FILETYPE_ASF,  "application/vnd.ms-asf",        wxTRANSLATE(L"Video ASF"),   KainoteFileKind::Video    },
	{ L".rmvb", IDI_FILETYPE_RMVB, "application/vnd.rn-realmedia",  wxTRANSLATE(L"Video RMVB"),  KainoteFileKind::Video    },
	{ L".rm",   IDI_FILETYPE_RM,   "application/vnd.rn-realmedia",  wxTRANSLATE(L"Video RM"),    KainoteFileKind::Video    },
	{ L".3gp",  IDI_FILETYPE_3GP,  "video/3gpp",                    wxTRANSLATE(L"Video 3GP"),   KainoteFileKind::Video    },
	{ L".mpg",  IDI_FILETYPE_MPG,  "video/mpeg",                    wxTRANSLATE(L"Video MPG"),   KainoteFileKind::Video    },
	{ L".mpeg", IDI_FILETYPE_MPEG, "video/mpeg",                    wxTRANSLATE(L"Video MPEG"),  KainoteFileKind::Video    },
	// .ts collides with Qt Linguist and TypeScript at the same glob weight.
	{ L".ts",   IDI_FILETYPE_TS,   "video/mp2t",                    wxTRANSLATE(L"Video TS"),    KainoteFileKind::Video    },
	{ L".m2ts", IDI_FILETYPE_M2TS, "video/mp2t",                    wxTRANSLATE(L"Video M2TS"),  KainoteFileKind::Video    },
};
