...
{
	//config
	convertConfig[L"AudioAutoCommit"] = std::pair<wxString, wxString>(L"AUDIO_AUTO_COMMIT", emptyString);
	convertConfig[L"AudioAutoFocus"] = std::pair<wxString, wxString>(L"AUDIO_AUTO_FOCUS", emptyString);
	convertConfig[L"AudioAutoScroll"] = std::pair<wxString, wxString>(L"AUDIO_AUTO_SCROLL", emptyString);
	convertConfig[L"AudioBoxHeight"] = std::pair<wxString, wxString>(L"AUDIO_BOX_HEIGHT", emptyString);
	convertConfig[L"AudioDelay"] = std::pair<wxString, wxString>(L"AUDIO_DELAY", emptyString);
	convertConfig[L"AudioDrawKeyframes"] = std::pair<wxString, wxString>(L"AUDIO_DRAW_KEYFRAMES", emptyString);
	convertConfig[L"AudioDrawSecondaryLines"] = std::pair<wxString, wxString>(L"AUDIO_DRAW_SECONDARY_LINES", emptyString);
	convertConfig[L"AudioDrawSelectionBackground"] = std::pair<wxString, wxString>(L"AUDIO_DRAW_SELECTION_BACKGROUND", emptyString);
	convertConfig[L"AudioDrawTimeCursor"] = std::pair<wxString, wxString>(L"AUDIO_DRAW_TIME_CURSOR", emptyString);
	convertConfig[L"AudioDrawVideoPosition"] = std::pair<wxString, wxString>(L"AUDIO_DRAW_VIDEO_POSITION", emptyString);
	convertConfig[L"AudioGrabTimesOnSelect"] = std::pair<wxString, wxString>(L"AUDIO_GRAB_TIMES_ON_SELECT", emptyString);
	convertConfig[L"AudioHorizontalZoom"] = std::pair<wxString, wxString>(L"AUDIO_HORIZONTAL_ZOOM", emptyString);
	convertConfig[L"AudioInactiveLinesDisplayMode"] = std::pair<wxString, wxString>(L"AUDIO_INACTIVE_LINES_DISPLAY_MODE", emptyString);
	convertConfig[L"AudioKaraoke"] = std::pair<wxString, wxString>(L"AUDIO_KARAOKE", emptyString);
	convertConfig[L"AudioKaraokeMoveOnClick"] = std::pair<wxString, wxString>(L"AUDIO_KARAOKE_MOVE_ON_CLICK", emptyString);
	convertConfig[L"AudioKaraokeSplitMode"] = std::pair<wxString, wxString>(L"AUDIO_KARAOKE_SPLIT_MODE", emptyString);
	convertConfig[L"AudioLeadIn"] = std::pair<wxString, wxString>(L"AUDIO_LEAD_IN_VALUE", emptyString);
	convertConfig[L"AudioLeadOut"] = std::pair<wxString, wxString>(L"AUDIO_LEAD_OUT_VALUE", emptyString);
	convertConfig[L"AudioLineBoundariesThickness"] = std::pair<wxString, wxString>(L"AUDIO_LINE_BOUNDARIES_THICKNESS", emptyString);
	convertConfig[L"AudioLink"] = std::pair<wxString, wxString>(L"AUDIO_LINK", emptyString);
	convertConfig[L"AudioLockScrollOnCursor"] = std::pair<wxString, wxString>(L"AUDIO_LOCK_SCROLL_ON_CURSOR", emptyString);
	convertConfig[L"AudioMarkPlayTime"] = std::pair<wxString, wxString>(L"AUDIO_MARK_PLAY_TIME", emptyString);
	convertConfig[L"AudioMergeEveryNWithSyllable"] = std::pair<wxString, wxString>(L"AUDIO_MERGE_EVERY_N_WITH_SYLLABLE", emptyString);
	convertConfig[L"AudioNextLineOnCommit"] = std::pair<wxString, wxString>(L"AUDIO_NEXT_LINE_ON_COMMIT", emptyString);
	convertConfig[L"AudioRAMCache"] = std::pair<wxString, wxString>(L"AUDIO_RAM_CACHE", emptyString);
	convertConfig[L"AudioSnapToKeyframes"] = std::pair<wxString, wxString>(L"AUDIO_SNAP_TO_KEYFRAMES", emptyString);
	convertConfig[L"AudioSnapToOtherLines"] = std::pair<wxString, wxString>(L"AUDIO_SNAP_TO_OTHER_LINES", emptyString);
	convertConfig[L"AudioSpectrumOn"] = std::pair<wxString, wxString>(L"AUDIO_SPECTRUM_ON", emptyString);
	convertConfig[L"AudioSpectrumNonLinearOn"] = std::pair<wxString, wxString>(L"AUDIO_SPECTRUM_NON_LINEAR_ON", emptyString);
	convertConfig[L"AudioStartDragSensitivity"] = std::pair<wxString, wxString>(L"AUDIO_START_DRAG_SENSITIVITY", emptyString);
	convertConfig[L"AudioVerticalZoom"] = std::pair<wxString, wxString>(L"AUDIO_VERTICAL_ZOOM", emptyString);
	convertConfig[L"AudioVolume"] = std::pair<wxString, wxString>(L"AUDIO_VOLUME", emptyString);
	convertConfig[L"AudioWheelDefaultToZoom"] = std::pair<wxString, wxString>(L"AUDIO_WHEEL_DEFAULT_TO_ZOOM", emptyString);
	convertConfig[L"AcceptedAudioStream"] = std::pair<wxString, wxString>(L"ACCEPTED_AUDIO_STREAM", emptyString);
	convertConfig[L"ASSPropertiesTitle"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TITLE", emptyString);
	convertConfig[L"ASSPropertiesScript"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_SCRIPT", emptyString);
	convertConfig[L"ASSPropertiesTranslation"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TRANSLATION", emptyString);
	convertConfig[L"ASSPropertiesEditing"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_EDITING", emptyString);
	convertConfig[L"ASSPropertiesTiming"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TIMING", emptyString);
	convertConfig[L"ASSPropertiesUpdate"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_UPDATE", emptyString);
	convertConfig[L"ASSPropertiesTitleOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TITLE_ON", emptyString);
	convertConfig[L"ASSPropertiesScriptOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_SCRIPT_ON", emptyString);
	convertConfig[L"ASSPropertiesTranslationOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TRANSLATION_ON", emptyString);
	convertConfig[L"ASSPropertiesEditingOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_EDITING_ON", emptyString);
	convertConfig[L"ASSPropertiesTimingOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_TIMING_ON", emptyString);
	convertConfig[L"ASSPropertiesUpdateOn"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_UPDATE_ON", emptyString);
	convertConfig[L"ASSPropertiesAskForChange"] = std::pair<wxString, wxString>(L"ASS_PROPERTIES_ASK_FOR_CHANGE", emptyString);
	convertConfig[L"AudioRecent"] = std::pair<wxString, wxString>(L"AUDIO_RECENT_FILES", L"|");
	convertConfig[L"AutomationLoadingMethod"] = std::pair<wxString, wxString>(L"AUTOMATION_LOADING_METHOD", emptyString);
	convertConfig[L"AutomationOldScriptsCompatybility"] = std::pair<wxString, wxString>(L"AUTOMATION_OLD_SCRIPTS_COMPATIBILITY", emptyString);
	convertConfig[L"AutomationRecent"] = std::pair<wxString, wxString>(L"AUTOMATION_RECENT_FILES", emptyString);
	convertConfig[L"AutomationScriptEditor"] = std::pair<wxString, wxString>(L"AUTOMATION_SCRIPT_EDITOR", emptyString);
	convertConfig[L"AutomationTraceLevel"] = std::pair<wxString, wxString>(L"AUTOMATION_TRACE_LEVEL", emptyString);
	convertConfig[L"AutoMoveTagsFromOriginal"] = std::pair<wxString, wxString>(L"AUTO_MOVE_TAGS_FROM_ORIGINAL", emptyString);
	convertConfig[L"AutoSaveMaxFiles"] = std::pair<wxString, wxString>(L"AUTOSAVE_MAX_FILES", emptyString);
	convertConfig[L"AutoSelectLinesFromLastTab"] = std::pair<wxString, wxString>(L"AUTO_SELECT_LINES_FROM_LAST_TAB", emptyString);
	convertConfig[L"ColorpickerRecent"] = std::pair<wxString, wxString>(L"COLORPICKER_RECENT_COLORS", emptyString);
	convertConfig[L"ConvertASSTagsOnLineStart"] = std::pair<wxString, wxString>(L"CONVERT_ASS_TAGS_TO_INSERT_IN_LINE", emptyString);
	convertConfig[L"ConvertFPS"] = std::pair<wxString, wxString>(L"CONVERT_FPS", emptyString);
	convertConfig[L"ConvertFPSFromVideo"] = std::pair<wxString, wxString>(L"CONVERT_FPS_FROM_VIDEO", emptyString);
	convertConfig[L"ConvertNewEndTimes"] = std::pair<wxString, wxString>(L"CONVERT_NEW_END_TIMES", emptyString);
	convertConfig[L"ConvertResolutionWidth"] = std::pair<wxString, wxString>(L"CONVERT_RESOLUTION_WIDTH", emptyString);
	convertConfig[L"ConvertResolutionHeight"] = std::pair<wxString, wxString>(L"CONVERT_RESOLUTION_HEIGHT", emptyString);
	convertConfig[L"ConvertShowSettings"] = std::pair<wxString, wxString>(L"CONVERT_SHOW_SETTINGS", emptyString);
	convertConfig[L"ConvertStyle"] = std::pair<wxString, wxString>(L"CONVERT_STYLE", emptyString);
	convertConfig[L"ConvertStyleCatalog"] = std::pair<wxString, wxString>(L"CONVERT_STYLE_CATALOG", emptyString);
	convertConfig[L"ConvertTimePerLetter"] = std::pair<wxString, wxString>(L"CONVERT_TIME_PER_CHARACTER", emptyString);
	convertConfig[L"CopyCollumnsSelection"] = std::pair<wxString, wxString>(L"COPY_COLLUMS_SELECTIONS", emptyString);
	convertConfig[L"DictionaryLanguage"] = std::pair<wxString, wxString>(L"DICTIONARY_LANGUAGE", emptyString);
	convertConfig[L"DisableLiveVideoEditing"] = std::pair<wxString, wxString>(L"DISABLE_LIVE_VIDEO_EDITING", emptyString);
	convertConfig[L"DontAskForBadResolution"] = std::pair<wxString, wxString>(L"DONT_ASK_FOR_BAD_RESOLUTION", emptyString);
	convertConfig[L"EditboxSugestionsOnDoubleClick"] = std::pair<wxString, wxString>(L"EDITBOX_SUGGESTIONS_ON_DOUBLE_CLICK", emptyString);
	convertConfig[L"EditorOn"] = std::pair<wxString, wxString>(L"EDITOR_ON", emptyString);
	...
	convertConfig[L"FindReplaceOptions"] = std::pair<wxString, wxString>(L"FIND_REPLACE_OPTIONS", emptyString);
	convertConfig[L"FontCollectorAction"] = std::pair<wxString, wxString>(L"FONT_COLLECTOR_ACTION", emptyString);
	convertConfig[L"FontCollectorDirectory"] = std::pair<wxString, wxString>(L"FONT_COLLECTOR_DIRECTORY", emptyString);
	convertConfig[L"FontCollectorFromMKV"] = std::pair<wxString, wxString>(L"FONT_COLLECTOR_FROM_MKV", emptyString);
	convertConfig[L"FontCollectorUseSubsDirectory"] = std::pair<wxString, wxString>(L"FONT_COLLECTOR_USE_SUBS_DIRECTORY", emptyString);
	convertConfig[L"FFMS2VideoSeeking"] = std::pair<wxString, wxString>(L"FFMS2_VIDEO_SEEKING", emptyString);
	convertConfig[L"GridChangeActiveOnSelection"] = std::pair<wxString, wxString>(L"GRID_CHANGE_ACTIVE_ON_SELECTION", emptyString);
	convertConfig[L"GridFontName"] = std::pair<wxString, wxString>(L"GRID_FONT", emptyString);
	convertConfig[L"GridFontSize"] = std::pair<wxString, wxString>(L"GRID_FONT_SIZE", emptyString);
	convertConfig[L"GridAddToFilter"] = std::pair<wxString, wxString>(L"GRID_ADD_TO_FILTER", emptyString);
	convertConfig[L"GridFilterAfterLoad"] = std::pair<wxString, wxString>(L"GRID_FILTER_AFTER_LOAD", emptyString);
	convertConfig[L"GridFilterBy"] = std::pair<wxString, wxString>(L"GRID_FILTER_BY", emptyString);
	convertConfig[L"GridFilterInverted"] = std::pair<wxString, wxString>(L"GRID_FILTER_INVERTED", emptyString);
	convertConfig[L"GridFilterStyles"] = std::pair<wxString, wxString>(L"GRID_FILTER_STYLES", L",");
	convertConfig[L"GridHideCollums"] = std::pair<wxString, wxString>(L"GRID_HIDE_COLUMNS", emptyString);
	convertConfig[L"GridHideTags"] = std::pair<wxString, wxString>(L"GRID_HIDE_TAGS", emptyString);
	convertConfig[L"GridIgnoreFiltering"] = std::pair<wxString, wxString>(L"GRID_IGNORE_FILTERING", emptyString);
	convertConfig[L"GridLoadSortedSubs"] = std::pair<wxString, wxString>(L"GRID_LOAD_SORTED_SUBS", emptyString);
	convertConfig[L"GridSaveAfterCharacterCount"] = std::pair<wxString, wxString>(L"GRID_SAVE_AFTER_CHARACTER_COUNT", emptyString);
	convertConfig[L"GridTagsSwapChar"] = std::pair<wxString, wxString>(L"GRID_TAGS_SWAP_CHARACTER", emptyString);
	convertConfig[L"InsertEndOffset"] = std::pair<wxString, wxString>(L"GRID_INSERT_END_OFFSET", emptyString);
	convertConfig[L"InsertStartOffset"] = std::pair<wxString, wxString>(L"GRID_INSERT_START_OFFSET", emptyString);
	convertConfig[L"KEYFRAMES_RECENT"] = std::pair<wxString, wxString>(L"KEYFRAMES_RECENT", L"|");
	convertConfig[L"MoveTimesByTime"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_BY_TIME", emptyString);
	convertConfig[L"MoveTimesLoadSetTabOptions"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_CHANGE_VALUES_WITH_TAB", emptyString);
	convertConfig[L"MoveTimesCorrectEndTimes"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_CORRECT_END_TIMES", emptyString);
	convertConfig[L"MoveTimesForward"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_MOVE_FORWARD", emptyString);
	convertConfig[L"MoveTimesFrames"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_DISPLAY_FRAMES", emptyString);
	convertConfig[L"MoveTimesOn"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_ON", emptyString);
	convertConfig[L"MoveTimesOptions"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_OPTIONS", emptyString);
	convertConfig[L"MoveTimesWhichLines"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_WHICH_LINES", emptyString);
	convertConfig[L"MoveTimesWhichTimes"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_WHICH_TIMES", emptyString);
	convertConfig[L"MoveTimesStyles"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_STYLES", emptyString);
	convertConfig[L"MoveTimesTime"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_TIME", emptyString);
	convertConfig[L"MoveVideoToActiveLine"] = std::pair<wxString, wxString>(L"MOVE_VIDEO_TO_ACTIVE_LINE", emptyString);
	convertConfig[L"NoNewLineAfterTimesEdition"] = std::pair<wxString, wxString>(L"EDITBOX_DONT_GO_TO_NEXT_LINE_ON_TIMES_EDIT", emptyString);
	convertConfig[L"OpenSubsInNewCard"] = std::pair<wxString, wxString>(L"OPEN_SUBS_IN_NEW_TAB", emptyString);
	convertConfig[L"OpenVideoAtActiveLine"] = std::pair<wxString, wxString>(L"OPEN_VIDEO_AT_ACTIVE_LINE", emptyString);
	convertConfig[L"PasteCollumnsSelection"] = std::pair<wxString, wxString>(L"PASTE_COLUMNS_SELECTION", emptyString);
	convertConfig[L"PlayAfterSelection"] = std::pair<wxString, wxString>(L"VIDEO_PLAY_AFTER_SELECTION", emptyString);
	convertConfig[L"PostprocessorEnabling"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_ON", emptyString);
	convertConfig[L"PostprocessorKeyframeBeforeStart"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_KEYFRAME_BEFORE_START", emptyString);
	convertConfig[L"PostprocessorKeyframeAfterStart"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_KEYFRAME_AFTER_START", emptyString);
	convertConfig[L"PostprocessorKeyframeBeforeEnd"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_KEYFRAME_BEFORE_END", emptyString);
	convertConfig[L"PostprocessorKeyframeAfterEnd"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_KEYFRAME_AFTER_END", emptyString);
	convertConfig[L"PostprocessorLeadIn"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_LEAD_IN", emptyString);
	convertConfig[L"PostprocessorLeadOut"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_LEAD_OUT", emptyString);
	convertConfig[L"PostprocessorThresholdStart"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_THRESHOLD_START", emptyString);
	convertConfig[L"PostprocessorThresholdEnd"] = std::pair<wxString, wxString>(L"POSTPROCESSOR_THRESHOLD_END", emptyString);
	convertConfig[L"PreviewText"] = std::pair<wxString, wxString>(L"STYLE_PREVIEW_TEXT", emptyString);
	convertConfig[L"ProgramLanguage"] = std::pair<wxString, wxString>(L"PROGRAM_LANGUAGE", emptyString);
	convertConfig[L"ProgramTheme"] = std::pair<wxString, wxString>(L"PROGRAM_THEME", emptyString);
	...
	convertConfig[L"SelectionsOptions"] = std::pair<wxString, wxString>(L"SELECT_LINES_OPTIONS", emptyString);
	convertConfig[L"SelectVisibleLineAfterFullscreen"] = std::pair<wxString, wxString>(L"GRID_SET_VISIBLE_LINE_AFTER_FULL_SCREEN", emptyString);
	convertConfig[L"SHIFT_TIMES_PROFILES"] = std::pair<wxString, wxString>(L"SHIFT_TIMES_PROFILES", L"\f");
	convertConfig[L"SpellcheckerOn"] = std::pair<wxString, wxString>(L"SPELLCHECKER_ON", emptyString);
	convertConfig[L"StyleEditFilterText"] = std::pair<wxString, wxString>(L"STYLE_EDIT_FILTER_TEXT", emptyString);
	convertConfig[L"StyleFilterTextOn"] = std::pair<wxString, wxString>(L"STYLE_EDIT_FILTER_TEXT_ON", emptyString);
	convertConfig[L"StyleManagerPosition"] = std::pair<wxString, wxString>(L"STYLE_MANAGER_POSITION", emptyString);
	convertConfig[L"StyleManagerDetachEditor"] = std::pair<wxString, wxString>(L"STYLE_MANAGER_DETACH_EDIT_WINDOW", emptyString);
	convertConfig[L"SubsAutonaming"] = std::pair<wxString, wxString>(L"SUBS_AUTONAMING", emptyString);
	convertConfig[L"SubsComparisonType"] = std::pair<wxString, wxString>(L"SUBS_COMPARISON_TYPE", emptyString);
	convertConfig[L"SubsComparisonStyles"] = std::pair<wxString, wxString>(L"SUBS_COMPARISON_STYLES", emptyString);
	convertConfig[L"SubsRecent"] = std::pair<wxString, wxString>(L"SUBS_RECENT_FILES", L"|");
	convertConfig[L"TextFieldAllowNumpadHotkeys"] = std::pair<wxString, wxString>(L"TEXT_FIELD_ALLOW_NUMPAD_HOTKEYS", emptyString);
	...
	convertConfig[L"VideoProgressBar"] = std::pair<wxString, wxString>(L"VIDEO_PROGRESS_BAR", emptyString);
	convertConfig[L"VideoRecent"] = std::pair<wxString, wxString>(L"VIDEO_RECENT_FILES", L"|");
	convertConfig[L"VideoVolume"] = std::pair<wxString, wxString>(L"VIDEO_VOLUME", emptyString);
	convertConfig[L"VideoWindowSize"] = std::pair<wxString, wxString>(L"VIDEO_WINDOW_SIZE", emptyString);
	convertConfig[L"VisualWarningsOff"] = std::pair<wxString, wxString>(L"VIDEO_VISUAL_WARNINGS_OFF", emptyString);
	convertConfig[L"WindowMaximized"] = std::pair<wxString, wxString>(L"WINDOW_MAXIMIZED", emptyString);
	convertConfig[L"WindowPosition"] = std::pair<wxString, wxString>(L"WINDOW_POSITION", emptyString);
	convertConfig[L"WindowSize"] = std::pair<wxString, wxString>(L"WINDOW_SIZE", emptyString);
	convertConfig[L"EditboxTagButtons"] = std::pair<wxString, wxString>(L"EDITBOX_TAG_BUTTONS", emptyString);
	...
	while (tokenize.HasMoreTokens()){
		...
		if (configrx.Matches(token)){
			...
			if (it != convertConfig.end()){
				...
				if (reps)
					changed++;
				if (it->second.second != emptyString){
					token.Replace(L"=", L"={\n\t", false);
