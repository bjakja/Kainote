...
void KaiToolbar::InitToolbar()
{
	...
	if(IDS.size()<1){
		IDS.Add(ID_OPENSUBS);IDS.Add(ID_OPVIDEO);IDS.Add(ID_SAVE);IDS.Add(ID_SAVEAS);IDS.Add(ID_SAVEALL);IDS.Add(ID_UNSUBS);/*IDS.Add(-1);*/IDS.Add(ID_EDITOR);IDS.Add(ID_FINDREP);
		IDS.Add(ID_STYLEMNGR);IDS.Add(ID_ASSPROPS);IDS.Add(ID_CHANGETIME);IDS.Add(ID_AUTO);/*IDS.Add(-1);*/IDS.Add(ID_ASS);IDS.Add(ID_SRT);IDS.Add(ID_SETTINGS);
	}
