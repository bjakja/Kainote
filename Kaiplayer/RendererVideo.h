...
public:
	...
	virtual bool OpenFile(const wxString &fname, wxString *textsubs, bool Dshow, bool vobsub, bool changeAudio = true){};
	virtual bool OpenSubs(wxString *textsubs, bool redraw = true, bool fromFile = false){};
	virtual bool Play(int end = -1){};
	virtual bool Pause(){};
	virtual bool Stop(){};
	...
	virtual int GetFrameTime(bool start = true){};
	virtual void GetStartEndDelay(int startTime, int endTime, int *retStart, int *retEnd){};
	virtual int GetFrameTimeFromTime(int time, bool start = true){};
	virtual int GetFrameTimeFromFrame(int frame, bool start = true){};
	...
	virtual int GetPlayEndTime(int time){};
	...
	virtual void DrawLines(wxPoint point){};
	virtual void DrawProgBar(){};
	...
	virtual wxArrayString GetStreams(){};
	virtual void SetVisual(bool settext = false, bool noRefresh = false){};
	virtual void ResetVisual(){};
	//it's safe to not exist visual
	//returns true if removed
	virtual bool RemoveVisual(bool noRefresh = false){};
	virtual byte *GetFramewithSubs(bool subs, bool *del){};
	virtual void Zoom(const wxSize &size){};
	virtual void DrawZoom(){};
	virtual void ZoomMouseHandle(wxMouseEvent &evt){};
	virtual void SetZoom(){};
	virtual void ResetZoom(){};
	virtual void SetVisualZoom(){};
	...
	virtual bool EnumFilters(Menu *menu){};
	virtual bool FilterConfig(wxString name, int idx, wxPoint pos){};
