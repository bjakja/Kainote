...
void StyleChange::UpdateValues(Styles *style, bool allowMultiEdition, bool enableNow)
{
	...
	if (an == "1"){ rb1->SetValue(true); }
	else if (an == "2"){ rb2->SetValue(true); }
	else if (an == "3"){ rb3->SetValue(true); }
	else if (an == "4"){ rb4->SetValue(true); }
	else if (an == "5"){ rb5->SetValue(true); }
	else if (an == "6"){ rb6->SetValue(true); }
	else if (an == "7"){ rb7->SetValue(true); }
	else if (an == "8"){ rb8->SetValue(true); }
	else if (an == "9"){ rb9->SetValue(true); };
...
void StyleChange::UpdateStyle()
{
	...
	wxString an;
	if (rb1->GetValue()){ an = "1"; }
	else if (rb2->GetValue()){ an = "2"; }
	else if (rb3->GetValue()){ an = "3"; }
	else if (rb4->GetValue()){ an = "4"; }
	else if (rb5->GetValue()){ an = "5"; }
	else if (rb6->GetValue()){ an = "6"; }
	else if (rb7->GetValue()){ an = "7"; }
	else if (rb8->GetValue()){ an = "8"; }
	else if (rb9->GetValue()){ an = "9"; };
	...
	updateStyle->Encoding = senc->GetString(senc->GetSelection()).BeforeFirst(L' ');
}
