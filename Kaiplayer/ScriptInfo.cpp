	...
	:wxDialog(parent, -1, _("W³aœciwoœci napisów ASS"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
{
	...
	wrapstyle->Append(_("1: Podzia³ co koniec linijki, dzieli tylko \\N"));
	...
	CheckBox2 = new wxCheckBox(this, -1, _("Skaluj obwódkê i cieñ"));
...
{
	height->SetToolTip(_("Wysokoœæ wideo"));
	width->SetToolTip(_("Szerokoœæ wideo"));
	wrapstyle->SetToolTip(_("Sposób dzielenia napisów"));
	collision->SetToolTip(_("Kolidowanie linijek"));
	CheckBox1->SetToolTip(_("Zmiana rozdzielczoœci tylko w nag³ówku napisów, odznaczenie powoduje przeskalowanie ca³ych napisów"));
	CheckBox2->SetToolTip(_("Skalowana obwódka i cieñ"));
}