...
int wxStrcmp(const wxString& s1, const T& s2);
int wxStricmp(const wxString& s1, const T& s2);
int wxStrcoll(const wxString& s1, const T& s2);;
int wxStrcoll(const wxString& s1, const T& s2);
size_t wxStrspn(const wxString& s1, const T& s2);
size_t wxStrcspn(const wxString& s1, const T& s2);
int wxStrncmp(const wxString& s1, const T& s2, size_t n);
int wxStrnicmp(const wxString& s1, const T& s2, size_t n);
