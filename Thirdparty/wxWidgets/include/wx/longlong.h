...
public:
    ...
    friend WXDLLIMPEXP_BASE
        ostream& operator<<(ostream&, const wxLongLongNative&);
#endif
...
public:
    ...
    // input/output
    friend WXDLLIMPEXP_BASE
        ostream& operator<<(ostream&, const wxULongLongNative&);
#endif
...
//    // warns about this
//    template<> struct numeric_limits<long long> : public numeric_limits<long long> {};
//    template<> struct numeric_limits<unsigned long long> : public numeric_limits<unsigned long long> {};
//#else
//    template<> class numeric_limits<long long> : public numeric_limits<long long> {};
//    template<> class numeric_limits<unsigned long long> : public numeric_limits<unsigned long long> {};
//#endif
...
template<>
struct WXDLLIMPEXP_BASE wxArgNormalizer<long long>
{
