...
wxDECLARE_EXPORTED_EVENT( , wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGED, wxSplitterEvent );
wxDECLARE_EXPORTED_EVENT( , wxEVT_COMMAND_SPLITTER_SASH_POS_CHANGING, wxSplitterEvent );
wxDECLARE_EXPORTED_EVENT( , wxEVT_COMMAND_SPLITTER_DOUBLECLICKED, wxSplitterEvent );
wxDECLARE_EXPORTED_EVENT( , wxEVT_COMMAND_SPLITTER_UNSPLIT, wxSplitterEvent );
